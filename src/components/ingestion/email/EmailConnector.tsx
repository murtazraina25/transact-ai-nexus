...
//   try {
//     const response = await getConnectedEmails(email);
//     console.log("Fetched connected emails:", response.data)

//     const mappedAccounts: EmailAccount[] = response.data.map((item: any) => ({
//       id: item.email_id,
//       provider: item.provider,
//       email: item.email,
//       status: item.status,
//       lastSync: item.lastSync ? new Date(item.lastSync) : undefined,
//       syncInterval: `${item.syncInterval}m`,
//       enabledFolders: item.enabledFolders.length,
//     }));
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              <Card>
                ...
                <CardContent>{selectedAccount.syncInterval} minutes</CardContent>
              </Card>
              <Card>
                <CardHeader>
                  <CardTitle>Enabled Folders</CardTitle>
